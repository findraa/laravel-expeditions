...
return [
    ...
    */
    ...
    'attributes' => [
        "user.name" => "nama",
        "user.address" => "alamat",
        "user.phone_number" => "No. telp",
        "user.email" => "email",
        "user.role" => "hak akses",
        "user.password" => "password",
        "user.password_confirmation" => "konfirmasi password",
        "expedition.name" => "nama ekspedisi",

        "area.expedition_id" => "jenis ekspedisi",
        "area.price" => "harga area",
        "area.weight" => "berat",
        "area.destination" => "tujuan",
        "area.estimate" => "estimasi",

        "detailTransaction.area_id" => "area tujuan",
        "detailTransaction.item_name" => "nama barang",
        "detailTransaction.qty" => "quantity",
        "detailTransaction.weight" => "berat",

        "transaction.sender_name" => "nama pengirim",
        "transaction.sender_phone" => "no. telp pengirim",
        "transaction.sender_address" => "alamat pengirim",
        "transaction.reciver_name" => "nama penerima",
        "transaction.reciver_phone" => "no. telp penerima",
        "transaction.reciver_address" => "alamat penerima",
        "transaction.city_id" => "kota tujuan",
        "transaction.user_id" => "kurir",
    ],
